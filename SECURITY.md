...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-ledger/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/ledger`) in the subject.
...
In scope: anything in `semitexa/ledger` that lets a request, a job or a message do
